...
<head>
    ...
    <title>Register - Fathur Backend</title>
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        @elseif (session()->has('failed'))
                                            <div class="alert alert-danger">Registrasi gagal</div>
                                        @endif
                                        <p class="px-2">please register for new account.</p>
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form action="{{ route('register.action') }}" method="post">
                                                    ...
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="text" name="email" class="form-control" id="user-email" placeholder="Email" required>
                                                        <div class="form-control-position">
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        <div><a href="{{ route('login') }}" class="card-link">Already have an account?</a></div>
                                                    </div>
